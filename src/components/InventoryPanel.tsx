    ...
    <div className="h-full flex flex-col bg-[#111] overflow-hidden">
      ...
      <div className="px-4 py-3 border-b border-white/10 bg-[#161616]">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] text-zinc-500">{filteredItems.length} 个可用</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <Search
            size={14}
            className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-600 group-focus-within:text-amber-500 transition-colors"
          />
        </div>
      </div>
        ...
        {CATEGORIES.map(cat => {
          ...
          return (
            ...
            >
              ...
              <span className="capitalize font-medium">{CATEGORY_NAMES[cat]}</span>
      ...
      <div className="flex-1 overflow-y-auto p-3 custom-scrollbar">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-40 text-center">
            ...
            <p className="text-zinc-500 text-sm">未选择组件目录</p>
            <button
          ...
          <div className="flex flex-col items-center justify-center h-40 text-center">
            ...
            <p className="text-zinc-600 text-sm">未找到组件</p>
          </div>
        ) : (
